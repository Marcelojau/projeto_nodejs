...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" placeholder=\"Coloque o nome do livro\" value=\"" +
    marko_escapeXmlAttr(data.livro.titulo) +
    "\"></div><div><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\" placeholder=\"150,35\" value=\"" +
    marko_escapeXmlAttr(data.livro.preco) +
    "\"></div><div><label for=\"descricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" placeholder=\"Insira a descrição do livro\">\r\n                    " +
